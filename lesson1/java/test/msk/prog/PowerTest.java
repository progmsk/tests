...
public class PowerTest {
    ...
    public void when4WithExp0Then1() {
        BigInteger result = Power.calculate(4, 0);
        assertEquals(BigInteger.valueOf(1), result);
    }
